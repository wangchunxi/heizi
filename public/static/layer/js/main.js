layui.config({
	...
	$.get("/static/layer/json/newsList.json",
		function(data){
			var waitNews = [];
	...
	//图片总数
	$.get("/static/layer/json/images.json",
		function(data){
	...
	//用户数
	$.get("/static/layer/json/usersList.json",
		function(data){
	...
	//新消息
	$.get("/static/layer/json/message.json",
		function(data){
	...
	if(window.sessionStorage.getItem("systemParameter")){
		...
		$.ajax({
			url : "/static/layer/json/systemParameter.json",
			type : "get",
			dataType : "json",
