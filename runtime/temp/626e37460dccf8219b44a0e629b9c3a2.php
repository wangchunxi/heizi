<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"/home/wwwroot/heizi/public/../app/admin/view/nav/info.html";i:1501379483;s:61:"/home/wwwroot/heizi/public/../app/admin/view/public/head.html";i:1501334649;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<fieldset class="layui-elem-field">
	...
	<form class="layui-form" id="form">
		<div class="layui-form-item">
			<?php
				dump($view_plug);
			if(is_array($view_plug) || $view_plug instanceof \think\Collection || $view_plug instanceof \think\Paginator): $i = 0; $__LIST__ = $view_plug;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
