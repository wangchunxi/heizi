<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"/home/wwwroot/heizi/public/../app/admin/view/index/info.html";i:1499778508;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<body class="childrenBody">
	...
	<div class="row">
		<div class="sysNotice col">
			...
			<div class="layui-elem-quote layui-quote-nm">
				...
				<p>* “个人资料”提供修改功能</p>
				<p>* 顶部天气信息自动判断位置【忘记之前是怎么想的做成北京的了，可能是我在大首都吧，哈哈。。。如果感觉页面打开速度太慢可以把这块代码注释掉】</p>
	...
	<script type="text/javascript" src="<?php echo __ADMIN_LAYER__; ?>/js/main.js"></script>
</body>
</html>